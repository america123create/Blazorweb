...
RECAPTCHA_SITE_KEY = os.environ.get('RECAPTCHA_SITE_KEY', '6LfoGWcsAAAAACXH34b3RlqqS63K7dsuTDlzX2Zt')
RECAPTCHA_SECRET_KEY = os.environ.get('RECAPTCHA_SECRET_KEY', '6LfoGWcsAAAAALeQfpYHn6rvSjMPAS7QcGVLnOhi')
